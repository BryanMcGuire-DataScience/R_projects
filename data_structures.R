...
df1=as.data.frame((cbind(x,y))) #convert to data frame
df1
...
data() # list all the data sets available
...
#factors could be things like levels: basic, intermediate., advanced 
